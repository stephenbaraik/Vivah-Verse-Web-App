...
import { ArrowLeft, QrCode, Gift, Wallet, Heart } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <h3 className="text-2xl font-light text-vivah-burgundy mb-6">Digital <span className="font-bold">Guestbook</span></h3>
            ...
            {MOCK_SHAGUN_TRANSACTIONS.map(t => (
              <GlassCard key={t.id} className="p-6 flex gap-4 items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 bg-vivah-petal/30 p-3 rounded-xl rounded-tl-none">
