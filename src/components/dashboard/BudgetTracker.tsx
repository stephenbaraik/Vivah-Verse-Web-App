...
import { IndianRupee, Plus, Trash2, Edit, ArrowLeft, TrendingUp, TrendingDown, ShoppingBag } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-3xl font-light text-vivah-burgundy">₹{totalBudget.toLocaleString('en-IN')}</span>
            </div>
          </div>
